...
public class RegulationChangedPayloadFactory implements PayloadFactory{
    ...
    public static class RegulationPayload extends EventPayloadForObjectChanged<RegulationText> {

        public RegulationPayload(RegulationText changed) {
            super(changed);
        }
    ...
    public EventPayload payloadFor(Object changedObject, ChangeKind changeKind) {
        return new RegulationPayload((RegulationText) changedObject);
    }
