...
import org.isisaddons.wicket.summernote.fixture.dom.regulation.RegulationTexts;
...
@DomainObject(objectType="REGULATIONTEXT",autoCompleteRepository= org.isisaddons.wicket.summernote.fixture.dom.regulation.RegulationTexts.class, autoCompleteAction="autoComplete")
...
public class RegulationText implements org.isisaddons.wicket.summernote.fixture.dom.regulation.Categorized, Comparable<RegulationText> {
...
// end region
    ...
    //region > eventsorg.apache.isis.applib.services.eventbus

    public static abstract class AbstractActionInteractionEvent extends ActionDomainEvent<RegulationText> {
    ...
    public static class DeletedEvent extends ActionDomainEvent {
        private static final long serialVersionUID = 1L;
        public DeletedEvent(
                final RegulationText source,
                final Identifier identifier,
