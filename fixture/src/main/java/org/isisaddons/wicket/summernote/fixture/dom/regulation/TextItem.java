...
// END SHOW applicability
    ...
    public TextItem storeSubSectionTextItem() {
        ...
        if (getDocumentURI() == null){
            ...
            // freeTextSection is the link back to Section, that is, to FreeText:
            documentComponentList.setParent(freeText.getDocumentURI());
